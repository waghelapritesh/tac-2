 ...
 *
 * Creates node_modules/@tac/* and node_modules/@waghelapritesh/* symlinks pointing
 ...
 * "files" field) and the @tac/* imports in compiled code need node_modules/@tac/*
 * to resolve. This script bridges the gap.
 *
 * Runs as part of postinstall (before any ESM code that imports @tac/*).
 *
...
const scopeDirs = {
  '@tac': join(REPO_ROOT, 'node_modules', '@tac'),
  '@waghelapritesh': join(REPO_ROOT, 'node_modules', '@waghelapritesh'),
}
