...
const RISK_TIERS = {
  ...
  high: [
    'TAC Workflow', 'Tool System', 'AI Providers', 'Extension Registry',
...
const SYSTEM_CHECKS = {
  ...
  'TAC Workflow':      'verify TAC workflow state transitions end-to-end',
...
function parseMap(mapPath) {
  ...
  for (const line of lines) {
    ...
    // Skip bold section headers like **TAC Extension (Core Workflow Engine)**
 ...
 *   - Glob prefix match:   tac/auto/*  matches  tac/auto/anything.ts
...
function renderConsole(report) {
  ...
  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log(' TAC2 PR Risk Report');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
