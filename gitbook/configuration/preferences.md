...
TAC preferences live in YAML frontmatter markdown files. You can configure them globally or per-project.

## Managing Preferences

```
/tac prefs              # open the global preferences wizard
/tac prefs project      # open the project preferences wizard
/tac prefs status       # show current values and where they come from
```
...
For project-specific patterns, use `.tac/KNOWLEDGE.md` instead — it's injected into every agent prompt automatically.
