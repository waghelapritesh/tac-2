...
TAC sends desktop notifications during auto mode to keep you informed without watching the terminal.
...
TAC uses `terminal-notifier` when available, falling back to `osascript`.
