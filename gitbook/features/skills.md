...
Skills are specialized instruction sets that TAC loads when the task matches. They provide domain-specific guidance — coding patterns, framework idioms, testing strategies, and tool usage.

Skills follow the open [Agent Skills standard](https://agentskills.io/) and work across multiple AI agents, not just TAC.
...
During `tac init`, TAC detects your project's tech stack and recommends relevant skill packs:
...
```
/tac skill-health              # overview table
