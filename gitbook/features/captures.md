...
Captures let you fire-and-forget thoughts during auto-mode execution. Instead of pausing auto mode to steer, capture ideas, bugs, or scope changes and let TAC triage them at natural seams between tasks.
...
2. **Triage** — between tasks, TAC classifies each capture
