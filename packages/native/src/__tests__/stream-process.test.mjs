...
import { processStreamChunk } from "@tac/native/stream-process";

// Runtime guard: the `processStreamChunk` native symbol shipped in the
// source tree is not present in every published `@waghelapritesh/engine-*`
...
const skipReason =
  typeof native?.processStreamChunk === "function"
    ? null
    : "native.processStreamChunk missing from @tac/native binary — see #4854";
