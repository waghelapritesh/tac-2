/**
 * TAC file parser — native Rust implementation.
 *
 * Parses `.tac/` directory markdown files containing YAML-like frontmatter
 ...
 */
export function batchParseTacFiles(
  directory: string,
): BatchParseResult {
  return (native as Record<string, Function>).batchParseTacFiles(
    directory,
  ) as BatchParseResult;
}
