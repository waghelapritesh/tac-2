...
export class ToolExecutionComponent extends Container {
	...
	private formatToolExecution(): string {
		...
		if (normalizedToolName === "read") {
			...
			// cleanly. TAC-registered MCP tools have already had their prefix
