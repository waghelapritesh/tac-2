import { type Component, truncateToWidth, visibleWidth } from "@tac/pi-tui";
...
export class FooterComponent implements Component {
	...
	render(width: number): string[] {
		...
		if (process.env.TAC_SHOW_TOKEN_COST === "1") {
		...
		// Group 4: context bar + percentage (mirrors /tac auto dashboard style).
