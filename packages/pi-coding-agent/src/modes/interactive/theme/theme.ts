...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@tac/pi-tui";
...
const NATIVE_TUI_HIGHLIGHT_ENABLED = process.env.TAC_ENABLE_NATIVE_TUI_HIGHLIGHT === "1";
...
const THEME_KEY = Symbol.for("@tac/pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@tac/pi-tui").SettingsListTheme {
	return {
