...
import type {
	...
	AgentTool,
	ThinkingLevel,
} from "@tac/pi-agent-core";
import type { AssistantMessage, ImageContent, Message, Model, TextContent } from "@tac/pi-ai";
import { modelsAreEqual, resetApiProviders, supportsXhigh } from "@tac/pi-ai";
...
export class AgentSession {
	...
	this.agent.reset();
		...
		if (this._cwd !== previousCwd) {
			...
			// tac_plan_slice to be missing from auto-mode subagent sessions.
