...
export class DefaultResourceLoader implements ResourceLoader {
	 ...
	 * For subdirectory extensions: the directory name (e.g. "/path/to/tac/index.ts" → "tac")
	 */
 ...
 * Given extensionsDir `/home/user/.tac/agent/extensions` and
 * ownerPath `/home/user/.tac/agent/extensions/mcp-client/index.js`,
