...
import * as _bundledPiAgentCore from "@tac/pi-agent-core";
import * as _bundledPiAi from "@tac/pi-ai";
import * as _bundledPiAiOauth from "@tac/pi-ai/oauth";
import type { KeyId } from "@tac/pi-tui";
import * as _bundledPiTui from "@tac/pi-tui";
...
// avoiding a circular dependency. Extensions can import from @tac/pi-coding-agent.
...
const STATIC_BUNDLED_MODULES: Record<string, unknown> = {
	...
	"@tac/pi-ai/oauth": _bundledPiAiOauth,
...
const EXTENSION_TIMING_ENABLED = process.env.TAC_STARTUP_TIMING === "1" || process.env.PI_TIMING === "1";
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		...
		"@tac/pi-coding-agent": packageIndex,
		"@tac/pi-agent-core": resolveWorkspaceOrImport("agent/dist/index.js", "@tac/pi-agent-core"),
		"@tac/pi-tui": resolveWorkspaceOrImport("tui/dist/index.js", "@tac/pi-tui"),
		"@tac/pi-ai": resolveWorkspaceOrImport("ai/dist/index.js", "@tac/pi-ai"),
		"@tac/pi-ai/oauth": resolveWorkspaceOrImport("ai/dist/oauth.js", "@tac/pi-ai/oauth"),
		"@sinclair/typebox": typeboxRoot,
		"yaml": yamlRoot,
		// Aliases for external PI ecosystem packages that import from the original scope
		"@mariozechner/pi-coding-agent": packageIndex,
		"@mariozechner/pi-agent-core": resolveWorkspaceOrImport("agent/dist/index.js", "@tac/pi-agent-core"),
		"@mariozechner/pi-tui": resolveWorkspaceOrImport("tui/dist/index.js", "@tac/pi-tui"),
		"@mariozechner/pi-ai": resolveWorkspaceOrImport("ai/dist/index.js", "@tac/pi-ai"),
		"@mariozechner/pi-ai/oauth": resolveWorkspaceOrImport("ai/dist/oauth.js", "@tac/pi-ai/oauth"),
	};
 ...
 * `moduleCache: false`, causing shared dependencies (e.g. @tac/pi-agent-core)
 ...
 * not called in the TAC loading flow. Extension discovery happens through
...
export async function discoverAndLoadExtensions(
	...
	// 2b. Installed extensions: ~/.tac/extensions/ merged with bundled (D-14, D-15)
	...
	for (const w of sortWarnings) {
		process.stderr.write(`[tac] ${w.message}\n`)
	}
