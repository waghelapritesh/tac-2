// TAC-2 — Regression tests for importLocalModule candidate resolution (#3954)
...
describe("_buildImportCandidates", () => {
  it("includes dist/ fallback for src/ paths", () => {
    const candidates = _buildImportCandidates("../../../src/resources/extensions/tac/db-writer.js");
    assert.ok(
      candidates.some((c) => c.includes("/dist/resources/extensions/tac/db-writer.js")),
      "should include dist/ swapped candidate",
    );
  });

  it("includes src/ fallback for dist/ paths", () => {
    const candidates = _buildImportCandidates("../../../dist/resources/extensions/tac/db-writer.js");
    assert.ok(
      candidates.some((c) => c.includes("/src/resources/extensions/tac/db-writer.js")),
  ...
  it("returns original path first", () => {
    const input = "../../../src/resources/extensions/tac/db-writer.js";
