...
/** Convert TAC content blocks to the Anthropic SDK's user-message content format. */
...
/** Map a TAC thinking level to the corresponding Anthropic effort value; model-specific for xhigh. */
...
/** Convert TAC messages to Anthropic SDK `MessageParam` format, applying cache control to the last user turn. */
...
/** Convert TAC tools to Anthropic SDK tool definitions, applying cache control to the last entry. */
...
/** Map an Anthropic API stop reason string to TAC's internal `StopReason`. */
