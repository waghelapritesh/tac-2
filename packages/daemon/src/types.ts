import type { RpcClient, SdkAgentEvent, RpcExtensionUIRequest } from '@waghelapritesh/rpc-client';
...
/**
 * A daemon-managed TAC headless session.
 */
...
export type ProjectMarker = 'git' | 'node' | 'tac' | 'rust' | 'python' | 'go';
...
export interface StartSessionOptions {
  ...
  /** Command to send after '/tac auto' (default: none) */
  command?: string;
  ...
  /** Path to CLI binary (overrides TAC_CLI_PATH and which resolution) */
  cliPath?: string;
}
...
/**
 * Formatted Discord message payload for a TAC event.
