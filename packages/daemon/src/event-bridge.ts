 ...
 *   - Conversation relay → Discord messages forwarded to TAC sessions
...
import type { SdkAgentEvent } from '@waghelapritesh/rpc-client';
...
export class EventBridge {
  ...
  // -----------------------------------------------------------------------
  // Conversation relay — Discord → TAC
  // -----------------------------------------------------------------------
  ...
  private async handleMessageCreate(message: Message): Promise<void> {
    ...
    // Otherwise, relay the message to the TAC session
