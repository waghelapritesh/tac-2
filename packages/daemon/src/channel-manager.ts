 ...
 * 'TAC Projects' category, with archive support.
 *
...
const DEFAULT_CATEGORY_NAME = 'TAC Projects';
const ARCHIVE_CATEGORY_NAME = 'TAC Archive';
const CHANNEL_PREFIX = 'tac-';
 ...
 *
 * Returns 'tac-unnamed' for empty/whitespace-only inputs.
 */
...
export class ChannelManager {
  ...
  /**
   * Create a text channel for a project under the TAC Projects category.
  ...
  /**
   * Archive a channel by moving it to the 'TAC Archive' category and
