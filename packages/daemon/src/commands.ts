...
export function buildCommands(): RESTPostAPIChatInputApplicationCommandsJSONBody[] {
  return [
    new SlashCommandBuilder()
      .setName('tac-status')
      .setDescription('Show status of all active TAC sessions')
      .toJSON(),
    new SlashCommandBuilder()
      .setName('tac-start')
      .setDescription('Start a new TAC session')
      .toJSON(),
    new SlashCommandBuilder()
      .setName('tac-stop')
      .setDescription('Stop a running TAC session')
      .toJSON(),
    new SlashCommandBuilder()
      .setName('tac-verbose')
...
/**
 * Format session list for /tac-status reply.
