...
export function QuickPanel() {
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-quick">
      <PanelHeader
        title="Quick Task"
          ...
          <div className="space-y-1.5">
            {[
              ...
              <div key={example} className="flex items-center gap-2 text-[11px]">
                ...
                <code className="font-mono text-muted-foreground">/tac quick {example}</code>
              </div>
            ))}
          </div>
        </div>
...
export function HistoryPanel() {
  ...
  const { loadHistoryData } = useTACWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-history">
      <PanelHeader
...
export function UndoPanel() {
  const workspace = useTACWorkspaceState()
  const { loadUndoInfo, executeUndoAction } = useTACWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-undo">
      <PanelHeader
...
export function SteerPanel() {
  const workspace = useTACWorkspaceState()
  const { loadSteerData, sendSteer } = useTACWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-steer">
      <PanelHeader
        title="Steer"
...
export function HooksPanel() {
  const workspace = useTACWorkspaceState()
  const { loadHooksData } = useTACWorkspaceActions()
  const state = workspace.commandSurface.remainingCommands.hooks
  const data = state.data as HooksData | null
  const busy = state.phase === "loading"

  return (
    <div className="space-y-4" data-testid="tac-surface-tac-hooks">
      <PanelHeader
        title="Hooks"
...
// ═══════════════════════════════════════════════════════════════════════
// 6. INSPECT PANEL — TAC database overview
// ═══════════════════════════════════════════════════════════════════════

export function InspectPanel() {
  const workspace = useTACWorkspaceState()
  const { loadInspectData } = useTACWorkspaceActions()
  const state = workspace.commandSurface.remainingCommands.inspect
  const data = state.data as InspectData | null
  const busy = state.phase === "loading"

  return (
    <div className="space-y-4" data-testid="tac-surface-tac-inspect">
      <PanelHeader
...
export function ExportPanel() {
  const workspace = useTACWorkspaceState()
  const { loadExportData } = useTACWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-export">
      <PanelHeader
        title="Export"
...
export function CleanupPanel() {
  const workspace = useTACWorkspaceState()
  const { loadCleanupData, executeCleanupAction } = useTACWorkspaceActions()
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-cleanup">
      <PanelHeader
        title="Cleanup"
...
export function QueuePanel() {
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-queue">
      <PanelHeader
        title="Queue"
...
export function StatusPanel() {
  ...
  return (
    <div className="space-y-4" data-testid="tac-surface-tac-status">
      <PanelHeader
        title="Status"
      ...
      {milestones.length === 0 && (
        <PanelEmpty message="No plan loaded — run /tac to initialize" />
      )}
    </div>
  )
}
