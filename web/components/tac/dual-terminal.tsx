...
import { MainSessionTerminal } from "@/components/tac/main-session-terminal"
import { ShellTerminal } from "@/components/tac/shell-terminal"
import { useTerminalFontSize } from "@/lib/use-terminal-font-size"
import { useTACWorkspaceState } from "@/lib/tac-workspace-store"
    ...
    <div ref={rootRef} className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-between border-b border-border bg-card px-4 py-2">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground">
          ...
          <span>Right: Interactive TAC</span>
        </div>
      </div>
