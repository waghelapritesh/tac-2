...
function getInputMode(state: ReturnType<typeof useTACWorkspaceState>): InputMode {
...
function inputModePlaceholder(mode: InputMode, state: ReturnType<typeof useTACWorkspaceState>): string {
...
export function Terminal({ className }: TerminalProps) {
  ...
  const { submitInput, sendAbort, sendSteer, consumeEditorTextBuffer } = useTACWorkspaceActions()
