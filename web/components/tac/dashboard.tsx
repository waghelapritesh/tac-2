...
} from "@/components/tac/loading-skeletons"
import { ScopeBadge } from "@/components/tac/scope-badge"
import { ProjectWelcome } from "@/components/tac/project-welcome"
...
export function Dashboard({ onSwitchView, onExpandTerminal }: DashboardProps = {}) {
  ...
  // Show welcome screen for projects that aren't initialized with TAC yet
