...
export function ForensicsPanel() {
  ...
  const { loadForensicsDiagnostics } = useTACWorkspaceActions()
...
export function DoctorPanel() {
  const workspace = useTACWorkspaceState()
  const { loadDoctorDiagnostics, applyDoctorFixes } = useTACWorkspaceActions()
...
export function SkillHealthPanel() {
  const workspace = useTACWorkspaceState()
  const { loadSkillHealthDiagnostics } = useTACWorkspaceActions()
