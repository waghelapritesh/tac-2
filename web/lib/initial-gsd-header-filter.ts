export type InitialTacHeaderFilterResult =
...
const TITLE_PATTERN = /Think. Architect. Code. v\d+\.\d+\.\d+/i
...
/**
 * Strip the decorative TAC startup banner from the beginning of a PTY stream.
 *
 ...
 */
export function filterInitialTacHeader(raw: string): InitialTacHeaderFilterResult {
