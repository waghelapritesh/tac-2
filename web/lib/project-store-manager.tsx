...
import { TACWorkspaceStore } from "./tac-workspace-store"

/**
 * ProjectStoreManager maintains a Map<string, TACWorkspaceStore> of per-project
...
export class ProjectStoreManager {
  private stores = new Map<string, TACWorkspaceStore>()
  ...
  getActiveStore(): TACWorkspaceStore | null {
   ...
   */
  switchProject(projectCwd: string): TACWorkspaceStore {
    ...
    if (!store) {
      store = new TACWorkspaceStore(projectCwd)
