...
export type CommandSurfaceTarget =
  ...
  | { kind: "tac"; surface: string; subcommand: string; args: string }
...
export function commandSurfaceSectionForRequest(request: CommandSurfaceOpenRequest): CommandSurfaceSection | null {
  switch (request.surface) {
    ...
    case "compact":
      return "compact"
    // TAC subcommand surfaces (S02)
    case "tac-status": return "tac-status"
    case "tac-visualize": return "tac-visualize"
    case "tac-forensics": return "tac-forensics"
    case "tac-doctor": return "tac-doctor"
    case "tac-skill-health": return "tac-skill-health"
    case "tac-knowledge": return "tac-knowledge"
    case "tac-capture": return "tac-capture"
    case "tac-triage": return "tac-triage"
    case "tac-quick": return "tac-quick"
    case "tac-history": return "tac-history"
    case "tac-undo": return "tac-undo"
    case "tac-inspect": return "tac-inspect"
    case "tac-prefs": return "tac-prefs"
    case "tac-config": return "tac-config"
    case "tac-hooks": return "tac-hooks"
    case "tac-mode": return "tac-mode"
    case "tac-steer": return "tac-steer"
    case "tac-export": return "tac-export"
    case "tac-cleanup": return "tac-cleanup"
    case "tac-queue": return "tac-queue"
    default:
      return null
  }
}
...
export function buildCommandSurfaceTarget(request: CommandSurfaceOpenRequest): CommandSurfaceTarget | null {
  ...
  // TAC subcommand surfaces — generic target (S02)
  if (request.surface?.startsWith("tac-")) {
    const subcommand = request.surface.slice(4) // "tac-forensics" -> "forensics"
    return { kind: "tac", surface: request.surface, subcommand, args: request.args ?? "" }
  }
