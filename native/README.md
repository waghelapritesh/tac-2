...
Rust N-API addon providing high-performance native modules for TAC.
...
Inspired by [Oh My Pi's pi-natives](https://github.com/can1357/oh-my-pi), adapted for TAC's Node.js runtime.
...
```typescript
import { grep, searchContent } from "@tac/native";
...
TAC file parsing and frontmatter extraction. Reads `.tac` files and extracts structured metadata from YAML frontmatter blocks.
...
HTML-to-Markdown conversion. Transforms HTML content into clean Markdown, useful for importing web content into TAC notes and documents.
