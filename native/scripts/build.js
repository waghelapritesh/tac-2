...
/**
 * Build script for the TAC native Rust addon.
 *
 * Usage:
...
console.log(`Building tac-engine (${profile})...`);
...
const libraryNames = {
  darwin: "libtac_engine.dylib",
  linux: "libtac_engine.so",
  win32: "tac_engine.dll",
};
