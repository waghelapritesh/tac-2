...
/**
 * Tree view provider that lists TAC session files from the same directory
 * as the currently active session.
 */
export class TacSessionTreeProvider implements vscode.TreeDataProvider<SessionItem>, vscode.Disposable {
	public static readonly viewId = "tac-sessions";
