...
import type { TacChangeTracker, Checkpoint } from "./change-tracker.js";
 ...
 */
export class TacCheckpointProvider implements vscode.TreeDataProvider<Checkpoint>, vscode.Disposable {
	public static readonly viewId = "tac-checkpoints";
