...
/**
 * Badges files in the VS Code explorer that TAC has written or edited
 * during the current session.
 */
export class TacFileDecorationProvider implements vscode.FileDecorationProvider, vscode.Disposable {
