<overview>
Non-negotiable rules and common gotchas when building TAC extensions.
</overview>
...
- Extension errors are logged but don't crash TAC — tool_call handler errors fail-safe (block the tool)
</common_patterns>
...
- Project-local: `.tac/extensions/*.ts`
- Project-local (subdir): `.tac/extensions/*/index.ts`

Note: `~/.tac/agent/extensions/` is reserved for bundled extensions synced from the tac-2 package.
