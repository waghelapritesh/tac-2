<overview>
Packaging extensions for distribution via npm, git, or local paths. Creating TAC/pi packages.
</overview>
...
<installing>
```bash
tac install npm:@foo/bar@1.0.0
tac install git:github.com/user/repo@v1
