...
<loading>
Extensions load when TAC starts (or on `/reload`). The default export function runs synchronously — subscribe to events and register tools/commands during this call.
