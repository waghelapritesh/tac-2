...
Ask the user:
- **Global** (`~/.pi/agent/extensions/`) — Available in all TAC sessions
- **Project-local** (`.tac/extensions/`) — Available only in this project
...
Verify:
- Extension loads without errors (check TAC startup output)
