...
<phase name="write">
Write the file to `.tac/workflow-defs/<name>.yaml`.

Tell the user:
- "Definition saved to `.tac/workflow-defs/<name>.yaml`."
- "Run `/tac workflow validate <name>` to check it against the schema."
- "Run `/tac workflow run <name>` to execute it."
</phase>

<success_criteria>
- A valid YAML file exists at `.tac/workflow-defs/<name>.yaml`
