...
- After `write-milestone-brief` when the brief needs a public-facing summary for non-TAC consumers
...
2. If it documents a decision, also append a one-line entry to `.tac/DECISIONS.md` pointing at the doc.
