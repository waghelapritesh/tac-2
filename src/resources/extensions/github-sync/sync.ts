 ...
 *
 * Entry point: `runGitHubSync()` — called from the TAC post-unit pipeline.
 * Routes to per-event sync functions based on the unit type, reads TAC
...
import { loadFile, parseSummary } from "../tac/files.js";
import { parseRoadmap, parsePlan } from "../tac/parsers-legacy.js";
import {
  resolveMilestoneFile,
  resolveSliceFile,
  resolveTaskFile,
} from "../tac/paths.js";
import { debugLog } from "../tac/debug-logger.js";
...
/**
 * Main sync entry point — called from TAC post-unit pipeline.
...
/**
 * Walk the `.tac/milestones/` tree and create GitHub entities for any
