 ...
 *
 * The mapping lives at `.tac/github-sync.json` and tracks which TAC
...
import { atomicWriteSync } from "../tac/atomic-write.js";
...
function mappingPath(basePath: string): string {
  return join(basePath, ".tac", MAPPING_FILENAME);
}
