...
import type { ExtensionAPI, Theme } from "@tac/pi-coding-agent";
import { Editor, type EditorTheme, Key, matchesKey, Text, truncateToWidth, wrapTextWithAnsi } from "@tac/pi-tui";
import { Type } from "@sinclair/typebox";
import { makeUI } from "./shared/tui.js";
import { maskEditorLine, type ProgressStatus } from "./shared/mod.js";
import { parseSecretsManifest, formatSecretsManifest } from "./tac/files.js";
import { resolveMilestoneFile } from "./tac/paths.js";
import type { SecretsManifestEntry } from "./tac/types.js";
...
// The implementation lives in env-utils.ts to avoid pulling @tac/pi-tui
// into modules that only need env-checking (e.g. files.ts during reports).
import { checkExistingEnvKeys } from "./tac/env-utils.js";
