...
1. \`~/.tac/agent/extensions/slash-commands/<name>.ts\` — the command implementation
2. Update \`~/.tac/agent/extensions/slash-commands/index.ts\` — import and register the new command alongside existing ones
...
- Import type: \`import type { ExtensionAPI, ExtensionCommandContext } from "@tac/pi-coding-agent";\`
