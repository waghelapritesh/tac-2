import { importExtensionModule, type ExtensionAPI, type ExtensionCommandContext } from "@tac/pi-coding-agent";
...
function getTacArgumentCompletions(prefix: string) {
...
export function registerLazyTACCommand(pi: ExtensionAPI): void {
  pi.registerCommand("tac", {
    description: "TAC — Think. Architect. Code.",
    getArgumentCompletions: getTacArgumentCompletions,
    handler: async (args: string, ctx: ExtensionCommandContext) => {
      const { handleTACCommand } = await importExtensionModule<typeof import("./commands.js")>(import.meta.url, "./commands.js");
