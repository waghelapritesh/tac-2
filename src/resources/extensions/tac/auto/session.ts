...
export class AutoSession {
  ...
  /** Explicit /tac model pin captured at bootstrap (session-scoped policy override). */
  ...
  /** Set when a TAC tool execution ends with isError due to malformed/truncated
  ...
  get lockBasePath(): string {
    ...
    // Strip /.tac/worktrees/ suffix if basePath is itself a worktree path
