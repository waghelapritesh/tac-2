...
describe("context-store: queryArtifact", () => {
  ...
  test("returns content for existing path", () => {
    ...
    insertArtifact({
      path: '.tac/milestones/M001/M001-PLAN.md',
    ...
    const plan = queryArtifact('.tac/milestones/M001/M001-PLAN.md');
...
`;
  ...
  test("S02 with S01 predecessor includes both rows", () => {
    const result = formatRoadmapExcerpt(sampleRoadmap, 'S02', '.tac/milestones/M005/M005-ROADMAP.md');
