// TAC — regression tests for issue #2630
...
import type { SliceRow, TaskRow, MilestoneRow } from '../tac-db.ts';
...
function makeTACState(overrides?: Partial<TACState>): TACState {
  return {
