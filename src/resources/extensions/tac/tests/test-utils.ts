/**
 * Shared test utilities for TAC extension tests.
 *
 ...
 */
export function makeTempRepo(prefix: string = "tac-test-"): string {
 ...
 */
export function makeTempDir(prefix: string = "tac-test-"): string {
...
/**
 * Create a minimal TAC milestone structure in a temp directory.
 *
 * @param base - Base directory (should have .tac/ or be a temp repo)
