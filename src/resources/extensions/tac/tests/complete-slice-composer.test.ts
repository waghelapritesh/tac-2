// TAC-2 — #4782 phase 3 batch 3: complete-slice migrated through composer.
...
function makeBase(): string {
  const base = mkdtempSync(join(tmpdir(), "tac-completeslice-composer-"));
...
function writeArtifacts(base: string): void {
  ...
  writeFileSync(
    join(base, ".tac", "milestones", "M001", "slices", "S01", "tasks", "T01-SUMMARY.md"),
