...
//
// The registered TAC tool is `search-the-web`, not `web_search`.
// `web_search` is an Anthropic API implementation detail that should
// never appear in TAC prompts or agent frontmatter.
// See: https://github.com/waghelapritesh/tac-2/issues/2920
