...
const tmpBase = mkdtempSync(join(tmpdir(), "tac-draft-promotion-test-"));
const tac = join(tmpBase, ".tac");

mkdirSync(join(tac, "milestones", "M001"), { recursive: true });

// Step 1: Create CONTEXT-DRAFT.md only → needs-discussion
const draftPath = join(tac, "milestones", "M001", "M001-CONTEXT-DRAFT.md");
...
const contextPath = join(tac, "milestones", "M001", "M001-CONTEXT.md");
...
const tmpBase2 = mkdtempSync(join(tmpdir(), "tac-draft-promotion-noop-"));
const tac2 = join(tmpBase2, ".tac");

mkdirSync(join(tac2, "milestones", "M001"), { recursive: true });
writeFileSync(
  join(tac2, "milestones", "M001", "M001-CONTEXT.md"),
...
const tmpBase3 = mkdtempSync(join(tmpdir(), "tac-draft-promotion-both-"));
const tac3 = join(tmpBase3, ".tac");

mkdirSync(join(tac3, "milestones", "M001"), { recursive: true });
writeFileSync(
  join(tac3, "milestones", "M001", "M001-CONTEXT.md"),
  "# M001: Full\n\nFull context.\n",
);
const bothDraftPath = join(tac3, "milestones", "M001", "M001-CONTEXT-DRAFT.md");
