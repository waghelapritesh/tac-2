...
function makeTask(overrides: Partial<TACTask> = {}): TACTask {
  return {
    id: 'T01',
    title: 'Setup Auth',
...
function makeSlice(overrides: Partial<TACSlice> = {}): TACSlice {
  return {
    id: 'S01',
    title: 'Auth System',
...
function makeMilestone(overrides: Partial<TACMilestone> = {}): TACMilestone {
  return {
    id: 'M001',
    title: 'Core Platform',
...
function makeSliceSummary(overrides: Partial<TACSliceSummaryData> = {}): TACSliceSummaryData {
  return {
...
function makeTaskSummary(overrides: Partial<TACTaskSummaryData> = {}): TACTaskSummaryData {
  return {
