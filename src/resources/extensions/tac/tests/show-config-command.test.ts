/**
 * /tac show-config command — structural tests.
 *
...
test("TACConfigOverlay class is exported", () => {
  assert.ok(
    overlaySrc.includes("export class TACConfigOverlay"),
    "TACConfigOverlay should be exported",
  );
});

test("TACConfigOverlay implements Component interface methods", () => {
