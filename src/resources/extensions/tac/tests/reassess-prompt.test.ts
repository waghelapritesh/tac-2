...
test('reassess-roadmap prompt loads and substitutes', () => {
    const testVars = {
      ...
      assessmentPath: ".tac/milestones/M099/slices/S03/S03-ASSESSMENT.md",
      roadmapPath: ".tac/milestones/M099/M099-ROADMAP.md",
    ...
    assert.ok(result.includes(".tac/milestones/M099/slices/S03/S03-ASSESSMENT.md"), "prompt contains assessmentPath");
    assert.ok(result.includes(".tac/milestones/M099/M099-ROADMAP.md"), "prompt contains roadmapPath");
...
test('reassess-roadmap contains coverage-check instruction', () => {
    const prompt = loadPromptFromWorktree("reassess-roadmap", {
      ...
      assessmentPath: ".tac/milestones/M001/slices/S01/S01-ASSESSMENT.md",
