...
export function resolve(specifier, context, nextResolve) {
  ...
  //    @tac/* specifier (including transitive ones pulled in by pi-coding-agent
  ...
  } else if (specifier === "@tac/pi-coding-agent") {
    specifier = new URL("packages/pi-coding-agent/src/index.ts", ROOT).href;
  } else if (specifier === "@tac/pi-ai/oauth") {
    specifier = new URL("packages/pi-ai/src/utils/oauth/index.ts", ROOT).href;
  } else if (specifier === "@tac/pi-ai") {
    specifier = new URL("packages/pi-ai/src/index.ts", ROOT).href;
  } else if (specifier === "@tac/pi-agent-core") {
    specifier = new URL("packages/pi-agent-core/src/index.ts", ROOT).href;
  } else if (specifier === "@tac/pi-tui") {
    specifier = new URL("packages/pi-tui/src/index.ts", ROOT).href;
  } else if (specifier === "@tac/native") {
    specifier = new URL("packages/native/src/index.ts", ROOT).href;
  } else if (specifier.startsWith("@tac/native/")) {
    // Sub-path imports like @tac/native/fd, @tac/native/text, etc.
    const subpath = specifier.slice("@tac/native/".length);
