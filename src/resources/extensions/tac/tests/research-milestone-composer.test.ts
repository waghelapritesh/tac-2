// TAC-2 — #4782 phase 3 batch 2: research-milestone migrated through composer.
...
function makeBase(): string {
  const base = mkdtempSync(join(tmpdir(), "tac-research-ms-composer-"));
...
test("#4782 phase 3: buildResearchMilestonePrompt preserves manifest order across optional artifacts (#4925 review)", async (t) => {
  ...
  seed(base, "M001");
  writeFileSync(join(base, ".tac", "milestones", "M001", "M001-CONTEXT.md"), "# M001 Context\n");
