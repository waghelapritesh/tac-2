...
// in the full barrel (mod.js → ui.js → @tac/pi-tui) which breaks when loaded
...
function metricsPath(base: string): string {
  return join(tacRoot(base), "metrics.json");
}
