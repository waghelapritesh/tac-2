/**
 * TAC Activity Log — Save raw chat sessions to .tac/activity/
 *
...
import { TACError, TAC_IO_ERROR } from "./errors.js";
...
function nextActivityFilePath(
  ...
  throw new TACError(TAC_IO_ERROR, `Failed to find available activity log sequence in ${activityDir}`);
}
