// TAC Extension — Notification History Overlay
// Scrollable panel showing all persisted notifications with severity filtering.
// Toggled with Ctrl+Alt+N (⌃⌥N on macOS), Ctrl+Shift+N fallback, or /tac notifications.

import type { Theme } from "@tac/pi-coding-agent";
import { truncateToWidth, visibleWidth, wrapTextWithAnsi, matchesKey, Key } from "@tac/pi-tui";
...
export class TACNotificationOverlay {
