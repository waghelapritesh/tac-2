...
function generatePRContent(basePath: string, milestoneId: string, milestoneTitle: string): PRContent {
  ...
  // AI disclosure
  sections.push("---\n");
  sections.push("*This PR was prepared with AI assistance (TAC auto-mode).*");
...
export async function handleShip(
  ...
  // 2. Check for incomplete work (use TAC phase as proxy — no phase field on ActiveRef)
