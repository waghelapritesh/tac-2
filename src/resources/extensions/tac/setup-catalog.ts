// TAC — Setup catalog (single source of truth for onboarding steps + provider sub-views)
//
// Re-exports filtered views over PROVIDER_REGISTRY (key-manager.ts) and owns the
// canonical ONBOARDING_STEPS list. Consumers (CLI wizard, /tac setup hub,
...
export interface OnboardingStepDef {
  ...
  required: boolean
  /** Short description shown in /tac setup status hub. */
  hint: string
}
...
export const ONBOARDING_STEPS: readonly OnboardingStepDef[] = [
  ...
  { id: "project",   label: "Project init",             required: false, hint: "Bootstrap .tac/ in this repo" },
]
