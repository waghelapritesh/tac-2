// TAC2 — Decisions -> memories backfill (ADR-013 step 5)
//
...
// payload preserving the original tac_save_decision schema (when_context,
...
import { isDbAvailable, _getAdapter } from "./tac-db.js";
