// TAC Memory Relations — knowledge-graph edges between memories
//
...
// extractor, or (b) future `/tac memory link` CLI commands. All writes go
// through the single-writer gate in `tac-db.ts`.
