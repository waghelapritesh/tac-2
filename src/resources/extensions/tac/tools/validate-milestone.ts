/**
 * validate-milestone handler — the core operation behind tac_validate_milestone.
 *
...
export async function handleValidateMilestone(
  ...
  if (milestoneDir) {
    ...
    const tacDir = join(canonicalBase, ".tac");
    const manualDir = join(tacDir, "milestones", params.milestoneId);
