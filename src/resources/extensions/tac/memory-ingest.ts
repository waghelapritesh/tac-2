// TAC Memory Ingest — turn raw content into memories
//
// Provides four entry points: ingestNote (inline text), ingestFile (local
// path), ingestUrl (HTTP resource), and ingestArtifact (a named .tac/ artifact
...
// `/tac memory rebuild` can re-extract from persisted sources.
