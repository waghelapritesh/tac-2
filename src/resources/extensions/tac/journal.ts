/**
 * TAC Event Journal — structured JSONL event log for auto-mode iterations.
 *
 * Writes daily-rotated JSONL files to `.tac/journal/YYYY-MM-DD.jsonl`.
 ...
 *
 * File path: `<tacRoot>/journal/<YYYY-MM-DD>.jsonl`
