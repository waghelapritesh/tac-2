/**
 * Worktree Health — lifecycle status helpers for TAC-managed worktrees.
 *
 * Used by doctor-checks.ts for health audits and by worktree-command.ts
 * for the enhanced `/worktree list` display.
 *
 * Only inspects worktrees under .tac/worktrees/ — TAC owns what TAC creates.
 */
...
/**
 * Compute health status for all TAC-managed worktrees.
 *
