/**
 * TAC Health Widget — always-on ambient health signal rendered belowEditor.
 *
 ...
 *
 * Widget key: "tac-health", placement: "belowEditor"
 */
...
/**
 * Initialize the always-on tac-health widget (belowEditor).
...
export function initHealthWidget(ctx: ExtensionContext): void {
  ...
  ctx.ui.setWidget("tac-health", buildHealthLines(initialData), { placement: "belowEditor" });

  // Factory-based widget for TUI mode — replaces the string-array above
  ctx.ui.setWidget("tac-health", (_tui, _theme) => {
