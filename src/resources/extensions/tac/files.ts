// TAC Extension - File Parsing and I/O
...
import { resolveMilestoneFile, relMilestoneFile, resolveTacRootFile } from './paths.js';
...
/**
 * The four UAT classification types recognised by TAC auto-mode.
...
export async function appendOverride(basePath: string, change: string, appliedAt: string): Promise<void> {
  const overridesPath = resolveTacRootFile(basePath, "OVERRIDES");
