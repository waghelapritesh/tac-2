...
export type DoctorIssueCode =
  ...
  | "symlinked_tac_unignored"
  | "unresolvable_dependency"
  | "failed_migration"
  | "broken_symlink"
  | "numbered_tac_variant"
...
export interface DoctorReport {
  ...
  issues: DoctorIssue[];
  fixesApplied: string[];
  /** Per-domain check durations in milliseconds. Present on explicit /tac doctor runs. */
  timing?: { git: number; runtime: number; environment: number; tacState: number };
}
