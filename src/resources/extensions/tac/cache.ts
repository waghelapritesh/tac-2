// TAC Extension — Unified Cache Invalidation
//
// Three module-scoped read caches exist across the TAC extension:
...
//
// After any file write that changes .tac/ contents, all three must be
...
// invoke clearArtifacts() from tac-db.js explicitly — do not add it back
// here.
...
/**
 * Invalidate all TAC runtime read caches in one call.
 *
 * Call this after file writes, milestone transitions, merge reconciliation,
 * or any operation that changes .tac/ contents on disk. Forgetting to clear
