/**
 * TAC Slice Parallel Conflict Detection — File overlap analysis between slices.
 *
...
export function hasFileConflict(
  ...
  const planPathA = join(basePath, ".tac", "milestones", mid, sliceA, "PLAN.md");
  const planPathB = join(basePath, ".tac", "milestones", mid, sliceB, "PLAN.md");
