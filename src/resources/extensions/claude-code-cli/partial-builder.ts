 ...
 * into TAC's `AssistantMessageEvent` deltas for incremental TUI rendering.
 */
...
import { hasXmlParameterTags, repairToolJson } from "@tac/pi-ai";
 ...
 *
 * Server names may contain hyphens (`tac-workflow`); the SDK uses the literal
...
/**
 * Build a TAC ToolCall block from a Claude Code SDK tool_use block, stripping
...
/**
 * Convert a single BetaContentBlock to the corresponding TAC content type.
 */
...
/**
 * Convert SDK usage + total_cost_usd into TAC's Usage shape.
 *
