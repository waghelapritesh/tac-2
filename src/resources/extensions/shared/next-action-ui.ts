/**
 * Shared next-action prompt for TAC extensions.
 *
 * Renders a consistent "step complete" UI at the end of every TAC stage:
 *
 *   ─────────────────────────────────────────
 ...
 *     ],
 *     notYetMessage: "Run /tac-plan-phase 1 when ready.",
 *   });
 *
...
import { Key, matchesKey, type TUI } from "@tac/pi-tui";
...
export interface NextActionOptions {
	 ...
	 * e.g. "Run /tac-plan-phase 1 when ready."
	 */
