// TAC-2 — Shared cmux event channel contracts
// Copyright (c) 2026 Jeremy McSpadden <jeremy@fluxlabs.net>

/**
 * Neutral event channel module for tac<->cmux IPC.
 * Both tac and cmux import from here — neither imports the other directly.
...
/** Migrated from cmux/index.ts (D-07) — shared by both tac and cmux. */
