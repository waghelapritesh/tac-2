/**
 * Shared UI design system for TAC/interview TUI components.
 *
...
import { truncateToWidth, visibleWidth, wrapTextWithAnsi } from "@tac/pi-tui";
...
export interface UI {
	...
	editorTheme: import("@tac/pi-tui").EditorTheme;
}
...
export function makeUI(theme: Theme, width: number): UI {
	...
	const editorTheme: import("@tac/pi-tui").EditorTheme = {
