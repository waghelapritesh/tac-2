// TAC2 — Ollama Extension: First-class local LLM support
/**
 * Ollama Extension
 *
...
import { importExtensionModule, type ExtensionAPI } from "@tac/pi-coding-agent";
...
export async function probeAndRegister(pi: ExtensionAPI): Promise<boolean> {
	...
	if (models.length === 0) {
		// No local models means there's nothing usable to register in TAC.
