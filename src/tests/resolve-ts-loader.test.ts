...
import { load as loadWithTestLoader, resolve as resolveWithTestLoader } from "../resources/extensions/tac/tests/dist-redirect.mjs"

const nextResolve = async (specifier: string) => ({ url: specifier })

const cases = [
  ["@tac/pi-coding-agent", "../../packages/pi-coding-agent/src/index.ts"],
] as const
