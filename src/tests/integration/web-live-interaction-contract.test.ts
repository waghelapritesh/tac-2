...
function makeWorkspaceFixture(): { projectCwd: string; sessionsDir: string; cleanup: () => void } {
  const root = mkdtempSync(join(tmpdir(), "tac-web-live-"));
...
//
// This mirrors the TACWorkspaceStore's handleEvent routing logic
...
/** Mirrors TACWorkspaceStore.routeLiveInteractionEvent */
