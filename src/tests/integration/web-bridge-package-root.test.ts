 ...
 *
 * Issue: waghelapritesh/tac-2#1881
...
test("resolveBridgeRuntimeConfig uses TAC_WEB_PACKAGE_ROOT when set", () => {
  const env = {
    TAC_WEB_PACKAGE_ROOT: "/custom/package/root",
    TAC_WEB_PROJECT_CWD: "/some/project",
...
test("resolveBridgeRuntimeConfig falls back to lazy default when TAC_WEB_PACKAGE_ROOT is absent", () => {
