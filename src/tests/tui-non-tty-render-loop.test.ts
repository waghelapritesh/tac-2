 ...
 *
 * When tac is spawned as an RPC bridge child process, stdout is a pipe
 ...
 *
 * Regression test for: https://github.com/waghelapritesh/tac-2/issues/3095
 */
import { describe, it, beforeEach } from "node:test";
import assert from "node:assert/strict";
import { ProcessTerminal } from "@tac/pi-tui";
import { TUI } from "@tac/pi-tui";
import type { Terminal } from "@tac/pi-tui";
