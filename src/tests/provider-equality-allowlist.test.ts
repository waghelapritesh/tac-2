// tac-2: provider-equality guardrail test (ADR-012)
//
...
//   helpers in @tac/pi-ai (isAnthropicApi / isOpenAIApi / isGeminiApi /
...
//      from @tac/pi-ai. This is the default answer.
  ...
  if (unauthorized.length > 0) {
    ...
    assert.fail(
      `New \`model.provider === "<transport>"\` check(s) detected in:\n${lines}\n\n` +
        ...
        `isAnthropicApi / isOpenAIApi / isGeminiApi / isBedrockApi from @tac/pi-ai.\n\n` +
