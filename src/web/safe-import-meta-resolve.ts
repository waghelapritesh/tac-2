 ...
 * absolute path (e.g. file:///home/runner/work/tac-2/tac-2/src/web/bridge-service.ts).
 ...
 * letting resolveBridgeRuntimeConfig() fall through to the TAC_WEB_PACKAGE_ROOT
