 ...
 * resolved under `node_modules/`. When TAC is installed globally via npm,
 * all source files live under `node_modules/tac-2/src/...`, so
 ...
 * with `--experimental-transform-types`.  When TAC is installed globally via
 ...
 *
 * @param packageRoot  Absolute path to the TAC package root.
...
/**
 * Builds the Node.js subprocess prefix args for running a TAC extension module.
 *
