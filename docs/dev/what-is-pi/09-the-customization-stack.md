...
**Placement:**
- `~/.tac/agent/extensions/` (global)
- `.tac/extensions/` (project-local)
...
**Placement:**
- `~/.tac/agent/prompts/` (global)
- `.tac/prompts/` (project-local)
...
**Placement:**
- `~/.tac/agent/themes/` (global)
- `.tac/themes/` (project-local)
