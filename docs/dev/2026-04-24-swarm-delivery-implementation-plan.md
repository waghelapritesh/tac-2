...
**Status:** In progress  
**Date:** 2026-04-24  
**Source spec:** https://raw.githubusercontent.com/jeremymcs/tac-2/2540b00211c61daa0574bd3419afec5ceef36ba4/docs/dev/specs/2026-04-24-swarm-delivery-plan-uok.md  
...
- Enforcing organization-level GitHub branch protection through this repository's own `.github/` files. GitHub routines in this plan belong to TAC's product code and generated workflow surfaces.

## Current Baseline

The repo already has the main UOK spine:

- `src/resources/extensions/tac/uok/contracts.ts` - turn, gate, audit, graph contracts.
- `src/resources/extensions/tac/uok/kernel.ts` - UOK entrypoint and emergency legacy fallback routing.
- `src/resources/extensions/tac/uok/gate-runner.ts` - unified gate runner and retry matrix.
- `src/resources/extensions/tac/uok/execution-graph.ts` - shared graph scheduler primitives.
- `src/resources/extensions/tac/uok/gitops.ts` - turn git transaction projection.
- `src/resources/extensions/tac/uok/audit.ts` - append-only audit envelope.
- `src/resources/extensions/tac/uok/plan-v2.ts` - compile-to-unit-graph path.
...
- `src/resources/extensions/tac/uok/contracts.ts`
- `src/resources/extensions/tac/uok/execution-graph.ts`
- `src/resources/extensions/tac/workflow-engine.ts`
- `src/resources/extensions/tac/engine-types.ts`
...
- Add dispatch reason codes:
  ...
  - `conflict`
  - `retry`
- Add a query-facing explanation object so `/tac query` can answer why a unit ran or why it is blocked.

Tests:

- Extend `src/resources/extensions/tac/tests/uok-contracts.test.ts`.
- Extend `src/resources/extensions/tac/tests/uok-execution-graph.test.ts`.
- Add or extend a query/explainability test near `src/resources/extensions/tac/tests/active-milestone-id-guard.test.ts` or `src/resources/extensions/tac/tests/dev-engine-wrapper.test.ts`.

### 1B. State Transition Matrix

Primary files:

- `src/resources/extensions/tac/state.ts`
- `src/resources/extensions/tac/auto/phases.ts`
- `src/resources/extensions/tac/tools/*.ts`
- new source artifact under `src/resources/extensions/tac/state-transition-matrix.*`
...
- Extend `src/resources/extensions/tac/tests/state-machine-full-walkthrough.test.ts`.
- Extend `src/resources/extensions/tac/tests/state-derivation-parity.test.ts`.
...
- `src/resources/extensions/tac/uok/contracts.ts`
- `src/resources/extensions/tac/uok/audit.ts`
- `src/resources/extensions/tac/uok/gitops.ts`
- `src/resources/extensions/tac/bootstrap/write-gate.ts`
- `src/resources/extensions/tac/sync-lock.ts`
- `src/resources/extensions/tac/atomic-write.ts`
...
- Extend `src/resources/extensions/tac/tests/write-gate.test.ts`.
- Extend `src/resources/extensions/tac/tests/uok-audit-unified.test.ts`.
- Extend `src/resources/extensions/tac/tests/uok-gitops-turn-action.test.ts`.
...
- Targeted UOK and state tests:
  - `node --import ./src/resources/extensions/tac/tests/resolve-ts.mjs --experimental-strip-types --test src/resources/extensions/tac/tests/uok-contracts.test.ts src/resources/extensions/tac/tests/uok-execution-graph.test.ts src/resources/extensions/tac/tests/state-machine-full-walkthrough.test.ts src/resources/extensions/tac/tests/write-gate.test.ts`
...
- `src/resources/extensions/tac/tests/custom-workflow-engine.test.ts`
- `src/resources/extensions/tac/tests/workflow-dispatch.test.ts`
- `src/resources/extensions/tac/tests/uok-execution-graph.test.ts`
- `src/resources/extensions/tac/tests/dispatch-missing-task-plans.test.ts`
...
- `src/resources/extensions/tac/tests/state-machine-full-walkthrough.test.ts`
- `src/resources/extensions/tac/tests/crash-recovery.test.ts`
- `src/resources/extensions/tac/tests/derive-state-db-disk-reconcile.test.ts`
- `src/resources/extensions/tac/tests/recovery-attempts-reset.test.ts`
...
- `src/resources/extensions/tac/tests/write-gate.test.ts`
- `src/resources/extensions/tac/tests/stale-lockfile-recovery.test.ts`
- `src/resources/extensions/tac/tests/uok-audit-unified.test.ts`
- `src/resources/extensions/tac/tests/uok-gitops-wiring.test.ts`
...
- `src/resources/extensions/tac/tests/uok-model-policy.test.ts`
- `src/resources/extensions/tac/tests/uok-plan-v2-wiring.test.ts`
...
3. Require maintainer review for:
   - `src/resources/extensions/tac/uok/**`
   - `src/resources/extensions/tac/state*`
   - `src/resources/extensions/tac/auto/**`
...
npm run typecheck:extensions
node --import ./src/resources/extensions/tac/tests/resolve-ts.mjs --experimental-strip-types --test <lane-targeted-tests>
...
node --import ./src/resources/extensions/tac/tests/resolve-ts.mjs --experimental-strip-types --test \
  src/resources/extensions/tac/tests/uok-contracts.test.ts \
  src/resources/extensions/tac/tests/uok-execution-graph.test.ts \
  src/resources/extensions/tac/tests/custom-workflow-engine.test.ts \
  src/resources/extensions/tac/tests/workflow-dispatch.test.ts
...
node --import ./src/resources/extensions/tac/tests/resolve-ts.mjs --experimental-strip-types --test \
  src/resources/extensions/tac/tests/state-machine-full-walkthrough.test.ts \
  src/resources/extensions/tac/tests/state-derivation-parity.test.ts \
  src/resources/extensions/tac/tests/crash-recovery.test.ts \
  src/resources/extensions/tac/tests/derive-state-db-disk-reconcile.test.ts
...
node --import ./src/resources/extensions/tac/tests/resolve-ts.mjs --experimental-strip-types --test \
  ...
  src/resources/extensions/tac/tests/stale-lockfile-recovery.test.ts \
  src/resources/extensions/tac/tests/uok-audit-unified.test.ts \
  src/resources/extensions/tac/tests/uok-gitops-turn-action.test.ts
