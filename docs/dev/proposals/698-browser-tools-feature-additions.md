...
> Ref: [#698](https://github.com/waghelapritesh/tac-2/issues/698)
...
| **Storage location** | Session artifacts directory: `.tac/browser-state/<name>.json` |
...
- [ ] State files written to `.tac/browser-state/` and gitignored
...
| **Baseline management** | Save baselines to `.tac/browser-baselines/`; auto-name by URL + viewport |
