...
| Location | Scope |
|----------|-------|
| `~/.tac/agent/extensions/*.ts` | Global (all projects) |
| `~/.tac/agent/extensions/*/index.ts` | Global (subdirectory) |
| `.tac/extensions/*.ts` | Project-local |
| `.tac/extensions/*/index.ts` | Project-local (subdirectory) |
